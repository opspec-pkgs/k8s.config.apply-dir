[![Build Status](https://github.com/opspec-pkgs/k8s.config.apply-dir/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/k8s.config.apply-dir/actions?query=workflow%3Abuild+branch%3Amain)
